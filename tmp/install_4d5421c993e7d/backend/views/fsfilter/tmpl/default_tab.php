 ...
 * @version $Id: default_tab.php 407 2011-01-24 09:30:22Z nikosdion $
 * @since 1.3
 */
...
<fieldset id="ak_roots_container_tab">
	...
	<div id="ak_list_container">
		<div id="addnewfilter">
			...
			<input type="button" value="<?php echo JText::_('FSFILTER_TYPE_DIRECTORIES') ?>" onclick="fsfilter_addnew('directories')" />
			&bull;
			<input type="button" value="<?php echo JText::_('FSFILTER_TYPE_SKIPFILES') ?>" onclick="fsfilter_addnew('skipfiles')" />
			&bull;
			<input type="button" value="<?php echo JText::_('FSFILTER_TYPE_SKIPDIRS') ?>" onclick="fsfilter_addnew('skipdirs')" />
			&bull;
			<input type="button" value="<?php echo JText::_('FSFILTER_TYPE_FILES') ?>" onclick="fsfilter_addnew('files')" />
		</div>
