...
<b><?php echo JText::_('MANAGE_CAREER_LEVELS');?></b><p> </p>
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th><?php echo JHTML::_('grid.sort', JText::_('DESCRIPTION'), 'description', $this->lists['orderDirection'], $this->lists['order']); ?></th>
