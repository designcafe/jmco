		...
		<p class="meta">
			...
			<?php
				...
				if ($this->params->get('show_author') && ($this->article->author != "")) {
					echo '<span><span>'.JText::_('Author').':</span> '.($this->article->created_by_alias ? $this->article->created_by_alias : $this->article->author).'</span>';
				}

				if (($this->params->get('show_section') && $this->article->sectionid) || ($this->params->get('show_category') && $this->article->catid)) {
					echo '<span><span>'.JText::_('Posted in ').':</span> ';
