...
<div id="yoo-zoo">
	<div class="downloads page-<?php echo $this->category->alias; ?>">
		...
		<?php if (($image = $this->category->getImage()) || $this->category->full_description || ($this->category->countItems() - $this->category->item_count)) : ?>
		<div class="category">
				...
				<?php
					if ($this->alpha_char) {
						echo JText::_('ALPHAINDEX TITLE').' '.strtoupper($this->alpha_char);
						 ...
						 echo $this->category->name.' '.JText::_('Archive');
					}
				?>
				<?php if ($title = $this->category->get('categories_title')) : ?>
		...
		<div class="items">
			...
			<h1 class="name">
				<?php echo $this->category->name.' '.JText::_('Files'); ?> 
