...
<div id="yoo-zoo">
	<div class="product page-<?php echo $this->category->alias; ?>">

		<?php if ($this->alpha_index == 2 || $this->alpha_char) : ?>
		...
		<?php if (!$this->alpha_char && (($image = $this->category->getImage()) || $this->category->full_description)) : ?>
		<div class="category">
			...
			<div class="box-1">
				...
				<h1 class="name"><?php echo $this->category->name; ?></h1>
		...
		<div class="sub-categories <?php if (($this->category->get('categories_title')) || $this->alpha_char) echo 'header'; ?>">

			<?php if (($title = $this->category->get('categories_title')) || $this->alpha_char) : ?>
				<h1 class="sub-categories-title"><span><span>
					<?php
						if ($this->alpha_char) {
							echo JText::_('ALPHAINDEX TITLE').' '.strtoupper($this->alpha_char);
						} else {
							echo $title;
						}
					?>
		...
		<div class="items <?php if ($this->category->get('items_title')) echo 'header'; ?>">
		
			<?php if ($title = $this->category->get('items_title')) : ?>
