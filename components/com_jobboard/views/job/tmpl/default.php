  ...
  <div id="jobsumm">
     <small>
       ...
       <div align="center" style="padding: 5px; margin-top: 5px">
          ...
          <a href="<?php echo JRoute::_($applink); ?>" class="readmore"> <div class="button applbut">&nbsp;&nbsp;<?php echo JText::_('APPLY_NOW'); ?>&nbsp;&nbsp;</div></a>
        <?php endif; ?>
        <?php if($this->config->send_tofriend == 1) :?>
          <a href="<?php echo JRoute::_($share); ?>" class="readmore">
