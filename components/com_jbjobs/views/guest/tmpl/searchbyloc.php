 ...
 * Author 		:	Faisel
 + Project		: 	Job site
 * File Name	:	views/guest/tmpl/searchbyloc.php
 * License		:	GNU General Public License version 3, or later
 ^ 
 * Description	: 	Shows list of jobs by location (jbjobs)
 ^ 
 * History		:	NONE
 * */
...
$action	= JRoute::_('index.php?option=com_jbjobs&view=guest&layout=searchbyloc&id='.$id);
?>

<div class="fsl_h3title"><b><?php echo JText::_('JBJOBS_LIST_OF_JOBS'); ?></b></div>


<span class="jbj_jobtitle"><b><?php echo JText::_('JBJOBS_COUNTRY'); ?> : <?php echo $this->spec->country; ?></b></span>
<form action="<?php echo $action; ?>" method="post" name="userFormJob" enctype="multipart/form-data">	
	<table width="100%" cellpadding="0" cellspacing="0">
	<thead>
		<tr class="jbj_rowhead">
			<th width="3%" class="jbj_rowhead">
				<?php echo JText::_('#'); ?>
			</th>
	...
	<tfoot>
		...
		<tr>
			<td colspan="6" class="jbj_row3">
				<a href="<?php echo JRoute::_('index.php?option=com_jbjobs&task=jbjobsrss&type=country&id='.$id); ?>"><img src="<?php echo JURI::root(); ?>components/com_jbjobs/images/rss.png" alt="RSS"></a>
			</td>
		</tr>
	</tfoot>
	<tbody>
