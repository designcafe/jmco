 ...
 * Author 		:	Faisel
 + Project		: 	Job site
 * File Name	:	views/guest/tmpl/searchbyind.php
...
$action	= JRoute::_('index.php?option=com_jbjobs&view=guest&layout=searchbyind&id='.$id);
?>

<div class="fsl_h3title"><b><?php echo JText::_('JBJOBS_LIST_OF_JOBS'); ?></b></div>


<span class="jbj_jobtitle"><b><?php echo JText::_('JBJOBS_INDUSTRY'); ?> : <?php echo $this->spec->industry; ?></b></span>
<form action="<?php echo $action; ?>" method="post" name="userFormJob" enctype="multipart/form-data">	
	...
	<tfoot>
		...
		<tr>
			<td colspan="6" class="jbj_row3">
				<a href="<?php echo JRoute::_('index.php?option=com_jbjobs&task=jbjobsrss&type=industry&id='.$id); ?>"><img src="<?php echo JURI::root(); ?>components/com_jbjobs/images/rss.png" alt="RSS"></a>
			</td>
		</tr>
	</tfoot>
	<tbody>
