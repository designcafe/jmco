 ...
 * Author 		:	Faisel
 + Project		: 	Job site
 * File Name	:	views/guest/tmpl/searchbypos.php
...
$action	= JRoute::_('index.php?option=com_jbjobs&view=guest&layout=searchbypos&id='.$id);
?>
	
<div class="fsl_h3title"><b><?php echo JText::_('JBJOBS_LIST_OF_JOBS'); ?></b></div>

<span class="jbj_jobtitle"><b><?php echo JText::_('JBJOBS_POSITION'); ?> : <?php echo $this->spec->pos_type; ?></b></span>
<form action="<?php echo $action; ?>" method="post" name="userFormJob" enctype="multipart/form-data">	
	...
	<tfoot>
		...
		<tr>
			<td colspan="6" class="jbj_row3">
				<a href="<?php echo JRoute::_('index.php?option=com_jbjobs&task=jbjobsrss&type=position&id='.$id); ?>"><img src="<?php echo JURI::root(); ?>components/com_jbjobs/images/rss.png" alt="RSS"></a>
			</td>
		</tr>
	</tfoot>
	<tbody>
