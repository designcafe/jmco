 ...
 * Tested by	:	Zaki
 + Project		: 	Job site
 * File Name	:	views/employer/tmpl/manualsubscr.php
...
?>
	...
	<div class="plan-choose" style="width:99.5%">
		...
		<table width="100%" border="0" cellspacing="2" cellpadding="4">
			...
			<tr>
				<td colspan="4" align="right"><?php echo $tax_name.' '.$this->subscr->tax_percent ;?>% :</td>
	...
	<div class="border">
		<table class="admintable" width="100%">
			...
			<tr ><th align="center" colspan="2"><input type="button" onclick="location.href='<?php echo $link_subscr_history; ?>';" value="<?php echo JText::_('JBJOBS_OK'); ?>" class="button"/></th></tr>
		</table>
	</div>
