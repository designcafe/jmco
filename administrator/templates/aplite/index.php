	...
	<div id="ap-header">
		...
		<div id="ap-mainmenu" class="mr20 fluid">
			...
			<ul>
				...
				<?php if (($user->get('gid') >= $menusAcl) && $menusAcl != 0) { ?><li <?php if ($option =="com_menus") { echo "class=\"active\""; } ?>><a href="index.php?option=com_menus"><!--<?php echo JText::_( 'MENUS' ); ?>-->MENUS</a></li><?php } ?>
				...
				<?php if (($user->get('gid') >= $articlesAcl) && $articlesAcl != 0) { ?><li <?php if ($option =="com_content" || $option == "com_sections" && $sectionsAcl == 0 || ($option =="com_categories" && $scope =="content") && $categoriesAcl == 0 || $option =="com_frontpage") { echo "class=\"active\""; } ?>><a href="index.php?option=com_content">
				<!-- <?php echo JText::_( 'ARTICLES' );?> --> CONTENT
				</a></li><?php } ?>
