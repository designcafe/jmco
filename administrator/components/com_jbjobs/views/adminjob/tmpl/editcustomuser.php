 ...
 * Author 		:	Faisel
 + Project		: 	Job site
 * File Name	:	views/adminjob/tmpl/editcustomuser.php
...
<script language="javascript" type="text/javascript">
	...
	function submitbutton(pressbutton) {
		...
		if (pressbutton == 'cancelcustomuser') {
			submitform( pressbutton );
			return;
		}
		
		// do field validation
		if (form.field_for[0].checked == false && form.field_for[1] == false)
		{
			alert( "<?php echo JText::_( 'You must select what the field for.', true ); ?>" );			
		}
...
<form action="index.php" method="post" name="adminForm">
	...
	<fieldset class="adminform">
		...
		<tr>
			<td class="key">
				<label>
					<?php echo JText::_( 'Field For' ); ?>:
				</label>
			</td>
			<td>
				<?php
				$put = array();
				$put[] = JHTML::_('select.option',  'employer', JText::_( 'Employer' ));
				$put[] = JHTML::_('select.option',  'jobseeker', JText::_( 'Job Seeker' ));
				echo JHTML::_('select.radiolist',  $put, 'field_for', '', 'value', 'text', $this->row->field_for );
				?>
			</td>
		</tr>
		<tr>
			<td class="key"><label for="field_title"><?php echo JText::_( 'Field Title' ); ?>:</label>
			</td>
			<td >
		...
		<tr>
			<td class="key"><label><?php echo JText::_( 'Required' ); ?>:</label>
			</td>
			<td>
		...
		<tr>
			<td class="key"><label for="class"><?php echo JText::_( 'Additional CSS Class (eg. inputbox)' ); ?>:</label>
			</td>
			<td >
		...
		<tr>
			<td class="key"><label><?php echo JText::_( 'Published' ); ?>:</label>
			</td>
			<td>
		...
		<tr>
			<td class="key"><label><?php echo JText::_( 'Field Type' ); ?>:</label>
			</td>
			<td>
				<select name="field_type">
					<?php $types = array('textbox', 'textarea', 'radio', 'checkbox', 'select', 'multiple select', 'URL', 'Email');
