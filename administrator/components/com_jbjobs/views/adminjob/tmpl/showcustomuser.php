 ...
 * Author 		:	Faisel
 + Project		: 	Job site
 * File Name	:	views/adminjob/tmpl/showcustomuser.php
...
<form action="index.php" method="post" name="adminForm">	
	...
	for ($i=0, $n=count($this->rows); $i < $n; $i++) {
		$row = $this->rows[$i];
		$link_edit	= JRoute::_( 'index.php?option=com_jbjobs&view=adminjob&layout=editcustomuser&cid[]='. $row->id );
		$row->checked_out = 0;
	...
	<input type="hidden" name="layout" value="showcustomuser" />
	<input type="hidden" name="task" value="" />
	<input type="hidden" name="ctype" value="profile" />
