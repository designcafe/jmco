...
<fieldset>
		...
		<input type="button" value="<?php echo JText::_('DBFILTER_LABEL_EXCLUDENONCORE'); ?>" onclick="dbfilter_exclude_noncms();"/>
		<input type="button" value="<?php echo JText::_('DBFILTER_LABEL_NUKEFILTERS'); ?>" onclick="dbfilter_nuke();"/>
