 ...
 * @version $Id: default.php 355 2010-12-24 11:32:41Z nikosdion $
 * @since 2.2
 */
...
?>
	...
	<div class="ui-state-error ui-corner-all notok updaterwarning">
		<?php echo JText::_('UPDATE_ERROR_USERNAMEPASSREQUIRED2'); ?>
	</div>
	<?php endif; ?>
	...
	<form enctype="multipart/form-data" action="index.php" method="post" name="adminForm" id="updateform">
		...
		<input type="submit" value="<?php echo JText::_('UPDATE_LABEL_UPDATENOW'); ?>" />
	</form>
	<?php endif; ?>
	...
	<form enctype="multipart/form-data" action="index.php" method="post" name="adminForm" id="requeryform">
		...
		<input type="submit" value="<?php echo JText::_('UPDATE_LABEL_FORCE'); ?>" />
	</form>
