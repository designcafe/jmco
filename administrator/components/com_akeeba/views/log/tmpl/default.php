...
<form name="adminForm" action="index.php" method="post">
	...
	<fieldset>
		...
		<input type="button" value="<?php echo JText::_('LOG_LABEL_DOWNLOAD'); ?>" onclick="window.location='<?php echo JURI::base(); ?>index.php?option=com_akeeba&view=log&task=download&format=raw&tag=<?php echo urlencode($this->tag); ?>';"></input>
		<?php endif; ?>
