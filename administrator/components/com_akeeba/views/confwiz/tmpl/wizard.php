 ...
 * @version $Id: wizard.php 407 2011-01-24 09:30:22Z nikosdion $
 * @since 1.3
 */
	...
	<fieldset>
		...
		<div id="finishedframe">
			...
			<div class="ak-action-button">
				...
				<input type="button"
					value="<?php echo JText::_('BACKUP'); ?>"
					onclick="window.location='<?php echo JURI::base() ?>index.php?option=com_akeeba&view=backup';"
				/>
			</div>
			<div class="ak-action-button">
				<div class="ak-icon ak-icon-configuration"></div>
				<input type="button"
					value="<?php echo JText::_('CONFIGURATION'); ?>"
					onclick="window.location='<?php echo JURI::base() ?>index.php?option=com_akeeba&view=config';"
				/>
			</div>
		</div>
	</fieldset>
