...
/*
   Class: CatalogModelCatalogs
   The Model Class for catalogs
*/
class CatalogModelCatalogs extends JModel {
	...
	function _buildQuery() {
		...
		// build query
		$query = ' SELECT a.*, COUNT(b.catalog_id) AS category_count'
			. ' FROM '.$table->getTableName().' AS a'
			. ' LEFT JOIN '.ZOO_TABLE_CATEGORY.' AS b ON a.id = b.catalog_id'
			. $where
			. ' GROUP BY a.id'
			. $orderby;
